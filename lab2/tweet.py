...
as a way to introduce the major concepts of object-oriented programming.
"""
...
class User:
    ...
    # Suppose we want to turn this function into a method.
    # Which class should we put it into? Once you've decided, move it.
    # This class, cause users do the retweeting, it is an action.
